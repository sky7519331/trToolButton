...
const addIcon = '<svg><svg viewBox="0 0 18 18" class="outline"><path d="M16 10h-6v6H8v-6H2V8h6V2h2v6h6z"></path></svg><svg viewBox="0 0 18 18" class="icon"><path d="M16 10h-6v6H8v-6H2V8h6V2h2v6h6z"></path></svg></svg>';
const deleteIcon = '<svg><svg viewBox="0 0 18 6" class="outline"><path d="M16 4H2V2h14z"></path></svg><svg viewBox="0 0 18 6" class="icon"><path d="M16 4H2V2h14z"></path></svg></svg>';
const pushIcon = '<svg><svg viewBox="0 0 18 18" class="outline"><path d="M16 10h-6v6H8v-6H2V8h6V2h2v6h6z"></path></svg><svg viewBox="0 0 18 18" class="icon"><path d="M16 10h-6v6H8v-6H2V8h6V2h2v6h6z"></path></svg></svg>';
