...
(function (exports) {
    ...
    ***************************************************************************** */
    ...
    const KEYWORDS_PLAYER_INFO = "人口";
    const KEYWORDS_PLAYER_ATTACKER = "攻擊者";
    const KEYWORDS_PLAYER_DEFENDER = "防禦者";
    const KEYWORDS_PLAYER_HERO_LEVEL = "英雄等級";
    const playerScoreKeyList = [
     ...
     * 需 https / localhost 下運作，且 clipboard API 必須獲得授權
     */
    const copyDivToClipboard = (elementId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const scriptMappings = [
        { pattern: /\/profile/, scriptPath: addButton$1 },
        { pattern: /\/report/, scriptPath: addButton },
    ];
    /**
     * 根據目前 URL，自動載入對應腳本。
